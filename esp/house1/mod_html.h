...
String buildRootPage(const String& ipStr, const String& modeText, const String& statusMessage) {
  ...
  s += "<title>Haus 1 – Wetterhaus</title>";
  s += "<style>";
  ...
  s += "<h1>Haus 1 – Wetterhaus </h1>";
  s += "<p><b>IP:</b> " + ipStr + "</p>";
  s += "<p><b>Modus:</b> " + modeText + "</p>";

  // Buttons
  s += "<p>";
  s += "<a href='/party/start'><button class='btn-party'>REGEN START</button></a>";
  s += "<a href='/party/stop'><button class='btn-party'>REGEN STOP</button></a>";
  s += "</p>";

   s += "<p>";
  s += "<a href='/party/start'><button class='btn-party'>WIND START</button></a>";
  s += "<a href='/party/stop'><button class='btn-party'>WIND STOP</button></a>";
  s += "</p>";

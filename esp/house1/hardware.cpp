...
const uint8_t PIN_MOTION        = 14;    // PIR Bewegungsmelder
// const uint8_t PIN_LEFT_BUTTON        = 16;    // Linker button (Gelb)
const uint8_t PIN_TEMPHUM       = 17;    // XHT11 Temperatur+Feuchte
...
// const uint8_t PIN_RIGHT_BUTTON        = 27;    // Rechter button beim Tür (Gelb)
